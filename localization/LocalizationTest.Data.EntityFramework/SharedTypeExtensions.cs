namespace LocalizationTest.Data.EntityFramework
{
    ...
    internal static class SharedTypeExtensions
    {
        ...
        private static bool IsGrouping(TypeInfo type) => type.IsGenericType && (type.GetGenericTypeDefinition() == typeof(IGrouping<,>) || type.GetGenericTypeDefinition() == typeof(IAsyncGrouping<,>));

        public static Type UnwrapEnumType(this Type type)
        {
            var isNullable = type.IsNullableType();
            var underlyingNonNullableType = isNullable ? type.UnwrapNullableType() : type;
            if (!underlyingNonNullableType.GetTypeInfo()
                    .IsEnum)
            {
                return type;
            }
        ...
        public static Type TryGetElementType(this Type type, Type interfaceOrBaseType)
        {
            ...
            return singleImplementation?.GetTypeInfo()
        ...
        public static IEnumerable<Type> GetGenericTypeImplementations(this Type type, Type interfaceOrBaseType)
        {
            ...
            {
                var baseTypes = interfaceOrBaseType.GetTypeInfo()
                                    .IsInterface
...
#pragma warning restore IDE0034 // Simplify 'default' expression
        ...
        public static object GetDefaultValue(this Type type)
        {
            ...
            // for all value types.
            return _commonTypeDictionary.TryGetValue(type, out var value) ? value : Activator.CreateInstance(type);
        }
